...
export const testCards = {
  ...
  basicProducer: {
    ...
    actions: {
      play: {},
      ability: {
        instructions: { key: "Choose this card and do nothing." },
        sequence: {
          choices: [
            {
              type: "cardId",
              name: "cardId",
              instructions: { key: "Choose this card." },
              min: 1,
              max: 1,
  ...
  producerThatCanDie: {
    ...
    actions: {
      ability: {
        instructions: {
          key: "Move one chip from this card to one of your consumers.",
        },
        sequence: {
  ...
  consumerWithTwoStepAbility: {
    ...
    actions: {
      play: {
        instructions: { key: "Bring into play with 1 chip from your reserve." },
        sequence: {
          choices: [
            {
              type: "chipId",
              name: "targetChips",
              instructions: { key: "Choose a chip from your reserve." },
              min: 1,
              max: 1,
              getValues: ({ accessor, context }) => {
                return accessor
  ...
  producerWithMultiPlayerAbility: {
    ...
    actions: {
      ...
      ability: {
        instructions: {
          key: "Each player may move up to 1 chip from their reserve to one of their consumers in play.",
        },
        sequence: {
          getPlayers: ({ accessor }) =>
          ...
          choices: [
            ...
            },
            {
              ...
              type: "cardId",
              instructions: {
                key: "Choose which consumer to move the chip to.",
              },
              min: 0,
              max: 1,
              getValues: ({ accessor, context }) =>
  ...
  producerWithChipChoices: {
    ...
    actions: {
      ...
      ability: {
        instructions: {
          key: "Move 1 chip from either your reserve or channel, and 1 chip from one of your other cards in play.",
        },
        sequence: {
          choices: [
            {
              ...
              name: "chips",
              instructions: {
                key: "Choose 1 chip from your reserve or channel.",
              },
              min: 1,
              max: 1,
              getValues: ({ accessor, context }) => {
            ...
            },
            {
              ...
              name: "chips",
              instructions: {
                key: "Choose 1 chip from another one of your cards in play.",
              },
              min: 1,
              max: 1,
              getValues: ({ accessor, context }) => {
  ...
  producerThatPassesTurn: {
    ...
    actions: {
      ability: {
        instructions: { key: "Pass the turn to the next player" },
        sequence: {
          choices: [],
